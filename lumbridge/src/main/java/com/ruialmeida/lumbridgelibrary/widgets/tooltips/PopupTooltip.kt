package com.ruialmeida.lumbridgelibrary.widgets.tooltips
...
import com.ruialmeida.lumbridgelibrary.extensions.views.afterMeasured
import com.ruialmeida.lumbridgelibrary.R
...
class PopupTooltip(
     ...
     */
    fun useTouchDelegateToIncreaseViewTouchArea() = apply { setupTouchDelegate(anchorView, anchorView.context) }
